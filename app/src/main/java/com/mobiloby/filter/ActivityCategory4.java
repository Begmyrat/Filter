...
//        popup("TikTok");
    ...
    private void sendBilgiler() {
        ...
        final String url = "http://anneligehazirlaniyorum.com/FilterMobil/insert_social_media.php";
...
//        progressDialog.show();
        ...
        final String url = "http://anneligehazirlaniyorum.com/FilterMobil/insert_friend_direk.php";
