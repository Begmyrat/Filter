...
import com.mobiloby.filter.databinding.FragmentTabOBinding;
import com.mobiloby.filter.models.DescribeObject;

import java.util.ArrayList;

public class TabFragmentO extends Fragment implements MyDescribeListAdapter.ItemClickListener {

    View view;
    FragmentTabOBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentTabOBinding.inflate(inflater);
