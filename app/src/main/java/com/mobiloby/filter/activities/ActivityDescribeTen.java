...
public class ActivityDescribeTen extends AppCompatActivity implements MyItemListAdapter.ItemClickListener, View.OnClickListener {

    View view;
    ActivityDescribeTenBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDescribeTenBinding.inflate(getLayoutInflater());
    ...
    private void prepareMe() {
        ...
        try {
            adapter.setSelectedIndex(preferences.getInt(benO+"ten_index", -1));
    ...
    public void onItemClick(View view, int position, int groupId) {
        if(groupId==1){
            ...
            editor.putInt(benO+"ten_index", position);
            editor.putString(benO+"ten_value", list.get(position));
            editor.commit();
