...
public class ActivityFriendMessage extends AppCompatActivity implements MyFriendListAdapter.ItemClickListener {
    ...
    private void prepareMe() {
        ...
        findViewById(R.id.c_main).getBackground().setTint(getResources().getColor(R.color.colorBackground));
    }
            ...
            protected void onPostExecute(String res) {
                ...
                if (res.equals("1")) {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(ActivityFriendMessage.this, "error jiimFriend", Toast.LENGTH_SHORT).show();
                    }
