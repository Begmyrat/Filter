...
import com.mobiloby.filter.models.OnBoardItemObject;
import com.mobiloby.filter.adapters.OnboardPagerAdapter;
...
public class ActivityOnboard extends AppCompatActivity {
    ...
    private void prepareMe() {
        ...
        list = new ArrayList<>();
//        list.add(new OnBoardItemObject("title 1", "description 1", R.drawable.ic_facebook));
//        list.add(new OnBoardItemObject("title 2", "description 2", R.drawable.ic_snapchat));
//        list.add(new OnBoardItemObject("title 3", "description 3", R.drawable.ic_instagram));
